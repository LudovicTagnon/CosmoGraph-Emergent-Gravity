...
Transfer-function slopes (signal cleaned of grid effects): $-1.61$ (mass) vs $-1.32$ (topology). A preliminary jackknife on 8 RA/DEC/$z$ sub-volumes (recomputing weights and random catalogs each time) yields slopes $P$: $-2.27\pm0.38$ (mass), $-1.85\pm0.39$ (topo) and $T$: $-0.99\pm0.75$ (mass), $-0.60\pm0.85$ (topo); errors remain large but confirm the qualitative trend. The close alignment indicates centrality captures the cosmological clustering beyond voxel artifacts.
