...
\begin{itemize}
  ...
  \item SDSS robustness (bootstrap on 5k slice, LCC $\sim$1909): eigenvector corr ranges $\sim 0.16$--$0.33$ when $k$ varies 5--30; skewness of eigenvector centrality $\sim 26$ (few hubs dominate). Closeness yields lower corr ($\sim 0.07$--$0.23$).
\end{itemize}
...
\begin{figure}[h]
  ...
  \caption{$P(k)$ (mass/topology) with a simple $\Lambda$CDM-like power-law reference ($n_s\simeq 0.96$, normalized at mid-$k$); illustrative only (no BAO/wiggles).}
\end{figure}
